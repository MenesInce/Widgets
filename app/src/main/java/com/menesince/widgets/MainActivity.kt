...
import com.menesince.widgets.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonOku.setOnClickListener {
            var alinanVeri = binding.editTextOku.text.toString()
            binding.textViewBilgi.text = alinanVeri
        }
        ...
        binding.switch1.setOnCheckedChangeListener { buttonView, isChecked -> // buttonView -> switch1 i temsil eder. isChecked -> true? or false?
            if (isChecked) {
